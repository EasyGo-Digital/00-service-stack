package eu.easygoit.helper;

import eu.easygoit.annotation.Criteria;
import eu.easygoit.enums.IEnumCombiner;
import eu.easygoit.enums.IEnumOperator;
import eu.easygoit.exception.WrongCriteriaFilterException;
...
public class CriteriaHelper {
     ...
     * @return the list
     */
    public static List<eu.easygoit.filter.Criteria> convertStringToCriteria(String criteria, String delim) {
        List<eu.easygoit.filter.Criteria> list = new ArrayList<>();
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            Arrays.stream(IEnumOperator.Types.values()).forEach(operator -> {
                if (finalToken.contains(operator.symbol())) {
                    ...
                    list.add(eu.easygoit.filter.Criteria.builder()
     ...
     */
    public static <T extends IIdEntity> Specification<T> buildSpecification(String domain, List<eu.easygoit.filter.Criteria> criteria, Class<?> classType) {
        Map<String, String> criteriaMap = CriteriaHelper.getCriteriaData(classType);
        Specification<T> specification = Specification.where(null);
        for (eu.easygoit.filter.Criteria cr : criteria) {
