...
import eu.easygoit.helper.SpringClassScanner;
...
public abstract class ControllerExceptionHandlerBuilder {
    ...
    private void processManagedException() {
        Set<BeanDefinition> managedExceptionBeans = springClassScanner.findAnnotatedClasses(MsgLocale.class, "eu.easygoit.exception");
